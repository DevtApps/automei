        ...
        children: [
          ListView(
            children: [
              Container(
                padding:
                    EdgeInsets.only(top: 18, bottom: 18, left: 18, right: 18),
                child: Row(
                  children: [
                    Expanded(
                      child: Container(
                    ...
                    Container(
                      ...
                      decoration: auth.currentUser?.photoURL != "default"
                          ? BoxDecoration(
              ...
              StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                builder: (c, snap) {
                  if (snap.hasData) {
                    ...
                    if (map.isEmpty)
                      return ListTile(
                        title: Text("Suas vendas recentes aparecerão aqui"),
                      );
                    else
                      return Column(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    subtitle: product.isStock
                                        ...
                                        : Text("não estocável"),
                                    trailing:
                                        Text(currency.format(product.value)),
                                  ),
                                ],
                              ));
                        },
